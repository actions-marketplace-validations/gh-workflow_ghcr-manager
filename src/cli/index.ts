...
function printUsage(): void {
  ...
  ghcr-manager plan --db <path> [--log-level <trace|debug|info|warn|error|silent>] --owner <org> --package <name> --delete-ghost-images [--exclude-tag <tag> ...] [--use-regex] [--keep-n-tagged <count>] [--older-than <interval>]
  ghcr-manager plan --db <path> [--log-level <trace|debug|info|warn|error|silent>] --owner <org> --package <name> --delete-partial-images [--exclude-tag <tag> ...] [--use-regex] [--keep-n-tagged <count>] [--older-than <interval>]
  ghcr-manager plan --db <path> [--log-level <trace|debug|info|warn|error|silent>] --owner <org> --package <name> --delete-orphaned-images [--exclude-tag <tag> ...] [--use-regex] [--keep-n-tagged <count>] [--older-than <interval>]
  ...
  ghcr-manager execute --db <path> [--log-level <trace|debug|info|warn|error|silent>] --owner <org> --package <name> --token <token> --delete-ghost-images [--exclude-tag <tag> ...] [--use-regex] [--keep-n-tagged <count>] [--older-than <interval>]
  ghcr-manager execute --db <path> [--log-level <trace|debug|info|warn|error|silent>] --owner <org> --package <name> --token <token> --delete-partial-images [--exclude-tag <tag> ...] [--use-regex] [--keep-n-tagged <count>] [--older-than <interval>]
  ghcr-manager execute --db <path> [--log-level <trace|debug|info|warn|error|silent>] --owner <org> --package <name> --token <token> --delete-orphaned-images [--exclude-tag <tag> ...] [--use-regex] [--keep-n-tagged <count>] [--older-than <interval>]
